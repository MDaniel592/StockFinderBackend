...
from utils.unalix._utils import get_python_version
from utils.unalix.__version__ import __version__
...
def create_ssl_context():
    ...
    ssl_options = ssl.OP_ALL | ssl.OP_NO_COMPRESSION | ssl.OP_SINGLE_DH_USE | ssl.OP_SINGLE_ECDH_USE

    python_version = get_python_version()

    # These options are deprecated since Python 3.7
    if python_version == 3.6:
        ssl_options |= ssl.OP_NO_SSLv2 | ssl.OP_NO_SSLv3 | ssl.OP_NO_TLSv1 | ssl.OP_NO_TLSv1_1 | ssl.OP_NO_TICKET
